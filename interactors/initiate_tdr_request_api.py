...
class InitiateTDRRequestApiInteractor:
    ...
    def initiate_tdr_request_api(
        ...
        self.tdr_request_storage.update_tdr_status(
            ...
            status=TDRRequestStatus.TDR_INITIATED.value
        )
    ...
    def _validate_if_current_status_is_pending_certificate_validation(
        ...
        if tdr_requests[0].status != TDRRequestStatus.CERTIFICATE_VALIDATED.value:
